...
BASE_FEATURES = ["cement", "slag", "fly_ash", "water", "superplasticizer", "coarse_aggregate", "fine_aggregate", "age"]

DERIVED_FEATURES = ["water_cement_ratio", "binder", "fine_to_coarse_ratio"]
